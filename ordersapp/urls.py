...
urlpatterns = [
    ...
    path('forming/complete/<pk>/', ordersapp.order_forming_complete, name='forming_complete'),
    path('update/orderitem/<int:pkProduct>/', ordersapp.order_item_update_price, name='order_update'),
]